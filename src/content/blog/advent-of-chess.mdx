---
title: 'An "Advent" of Chess'
description: 'In which Freyja gets nerd-sniped by a friend'
pubDate: '1 Dec 2024'
heroImage: '/lichess-default-board-state.png'
heroAlt: 'A lichess.org generated image of the initial board state for Chess'
---
